import {validateCaseFields,emptyChecks,transition,eventLabel,problem,localDate} from './domain.js';
export class DemoStore {
  constructor() {
    ...
    const entries=[
      ...
      ['10022','Bruno Exemplo','Omint','Dr. Diego','Ombro','Esquerdo','1','autorizacao',3,{}],
      ...
      ['10025','Elisa Exemplo','Cassi','Dr. Lucas','Tornozelo','Direito','2','realizado',-1,{autorizada:true}],
      ['10026','Felipe Exemplo','Seguros Unimed','Dr. Victor','Ombro','Direito','1','concluido',-6,{autorizada:true,assinada:true,execucao:true,documentos:true}],
      ['10027','Gabriela Exemplo','GEAP','Dr. Renato','Cotovelo','Esquerdo','1','autorizacao',4,{}],
      ['10028','Hugo Exemplo','Vivest','Dr. Yuri','Joelho','Direito','3','realizado',-3,{autorizada:true,assinada:true,execucao:true,documentos:true}],
      ['10021','Ana Exemplo','Bradesco Saúde','Dr. Arthur','Joelho','Direito','1','concluido',-34,{autorizada:true,assinada:true,execucao:true,documentos:true}],
      ['10021','Ana Exemplo','Bradesco Saúde','Dr. Arthur','Ombro','Esquerdo','1','concluido',-32,{autorizada:true,assinada:true,execucao:true,documentos:true}],
    ...
    this.records=entries.map(([prontuario,paciente,convenio,executor,articulacao,lado,numeroAplicacao,stage,days,checks],i)=>{
      ...
      return {id:`demo-${String(i+1).padStart(3,'0')}`,fields:{prontuario,paciente,convenio,medicacao:'Osteonil',articulacao,lado,numeroAplicacao,pedidoRacimed:`RC-${202600+i}`,aplicacao:`${numeroAplicacao}ª aplicação · ${articulacao} ${lado.toLowerCase()}`,data:localDate(date),executor,atendente:'Equipe de demonstração'},
